...
教師編纂講義（本 repo `notebooks/`，Colab 一鍵開啟，見下表）。
...
- Silberschatz, A., Korth, H. F., Sudarshan, S., 2019. Database System Concepts. 7th ed., McGraw-Hill.（[章末 Practice Exercises 官方解答](https://www.db-book.com/)）
...
| 上課時間 | 課程進度 | Colab |
|----------|----------|-------|
| 09/10 | [U01 Python 入門與資料庫初探](notebooks/unit01.ipynb) | <a href="https://colab.research.google.com/github/chang-ye-tu/db/blob/master/notebooks/unit01.ipynb"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> |
...
鼓勵使用 ChatGPT / Claude / Gemini 等工具協助學習與開發；作業與專題需附 AI 使用說明，且**報告時要能解釋每一行程式**。
